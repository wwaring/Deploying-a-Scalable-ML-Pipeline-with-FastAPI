...
def performance_on_categorical_slice(
    ...
    # TODO: implement the function
        # your code here
        # for input data, use data in column given as "column_name", with the slice_va>
        # use training = False

    # Troubleshooting Slicedata NameError by filtering the data for the specified slice
